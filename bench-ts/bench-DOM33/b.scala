...
object Main:
  ...
  def test2() =
    makeDOM { tree => ts =>
      ...
      val s25 = tree.open(HEAD())
      {

      implicit val s25_cap = s25.b
      val s26 = tree.open(TITLE())
      {

      implicit val s26_cap = s26.b
      val s27 = tree.open(BODY())
      {
      ...
      val s29 = tree.open(HEAD())
      {

      implicit val s29_cap = s29.b
      val s30 = tree.open(TITLE())
      {

      implicit val s30_cap = s30.b
      val s31 = tree.open(BODY())
      {
      ...
      val s49 = tree.close(P())
      {

      implicit val s49_cap = s49.b
      val s50 = tree.close(BODY())
      {

      implicit val s50_cap = s50.b
      val s51 = tree.close(TITLE())
      {

      implicit val s51_cap = s51.b
      val s52 = tree.close(HEAD())
      {

      implicit val s52_cap = s52.b
      val s53 = tree.close(P())
      {

      implicit val s53_cap = s53.b
      val s54 = tree.close(BODY())
      {

      implicit val s54_cap = s54.b
      val s55 = tree.close(TITLE())
      {

      implicit val s55_cap = s55.b
      val s56 = tree.close(HEAD())
      {

      implicit val s56_cap = s56.b
      val s57 = tree.close(P())
      {

      implicit val s57_cap = s57.b
      val s58 = tree.close(BODY())
      {

      implicit val s58_cap = s58.b
      val s59 = tree.close(TITLE())
      {

      implicit val s59_cap = s59.b
      val s60 = tree.close(HEAD())
      {

      implicit val s60_cap = s60.b
      val s61 = tree.close(P())
      {

      implicit val s61_cap = s61.b
      val s62 = tree.close(BODY())
      {

      implicit val s62_cap = s62.b
      val s63 = tree.close(TITLE())
      {

      implicit val s63_cap = s63.b
      val s64 = tree.close(HEAD())
      {

      implicit val s64_cap = s64.b
      tree.close(HTML())
      }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
    }
